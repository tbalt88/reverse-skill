...
if ($t -match 'ghidra|ghidra.?mcp|analyzeheadless') { [void]$sel.Add('R22') }
...
if ($t -match 'active.?directory|\bad\b.?cs|bloodhound|kerberoast|as-?rep|certipy|ntlm.?relay|dc.?sync|域.?渗透|域控|kerberos.?攻击|ad.?证书') { [void]$sel.Add('R24') }
